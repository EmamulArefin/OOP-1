...
//Enter New Password
		...
		new TextPrompt("New Password", enterPass_Field);
...
//Change Password Button
		...
		ChangePass_Button.setBackground(Dark_Blue);
	...
	//Add hover in login button
		ChangePass_Button.addMouseListener(new java.awt.event.MouseAdapter() {
			public void mouseEntered(java.awt.event.MouseEvent evt) {
				ChangePass_Button.setBackground(Dark_CYAN);
				ChangePass_Button.setForeground(Color.WHITE);
			}
...
//Set Background Image
		ImageIcon Newpass_Background = new ImageIcon("D:\\University\\3rd semester\\Java Project\\Final Project\\SOURCES\\Images\\New_Password.jpg");
...
//ActionListener for Change Passwoerd button
...
///////////////////////////////////////
			...
			//Getting username from file, whice password will be change
					try{
						File admin_file = new File("D:\\University\\3rd semester\\Java Project\\Final Project\\SOURCES\\TXT FILES\\OTP.txt");		
