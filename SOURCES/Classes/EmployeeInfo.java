...
public class EmployeeInfo
{
	...
	public EmployeeInfo()
	{
	 //Main Frame;
		...
		//for table;
		String order_data[][] = new String [employeefileNO][3];
		...
		String table_colume[] ={"Serial","Employee Name","Employee ID "};
