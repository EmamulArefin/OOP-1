...
public class IslamicBooks{
	...
	String book_Id, book_Price, book_name, book_category, book_path, book_author,book_quantity;
		...
		public IslamicBooks()
		{
			...
			ImageIcon icon4 = new ImageIcon("E:\\Book_Images\\Fera.jpg");   
			...
			lable1.setBounds(35,153,200,281);
			...
			lable3.setBounds(100,470,90,20);
		   ...
		   //////////////////////.....Jlabel-5(2 no book name)........./////////////////////
			...
			lable5.setBounds(335,445,120,20);
			...
			lable6.setBounds(335,470,100,20);
		   ...
		   //////////////////////.....Jlabel-8(3 no Book Nmae)........./////////////////////
			...
			lable8.setBounds(588,445,120,20);                      
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			...
			lable10.setBounds(770,154,194,281);
			lable10.setToolTipText("Book name : "+book_name);
		...
		//////View4 Batton....................
		   ...
		   view4batton.setToolTipText("Click to view Details");
		...
		//////View(2 No)Batton................(Data structures).....
		   ...
		   view2batton.setToolTipText("Click to view Details");
		   c.add(view2batton);
		...
		//////View2 Batton................(Harry Potter)......
		   ...
		   view3batton.setToolTipText("Click to view Details");
		   c.add(view3batton);
