...
//Books Button
		...
		books_Button.setCursor(new Cursor(Cursor.HAND_CURSOR));
		books_Button.setFont(upperButtonFont);
		books_Button.setBackground(Dark_CYAN);
		books_Button.setForeground(Color.WHITE);
		panel.add(books_Button);

		//Books Button Hover
		books_Button.addMouseListener(new java.awt.event.MouseAdapter() {
			public void mouseEntered(java.awt.event.MouseEvent evt) {
...
//Users Name Display
		...
		nameLabel.setBounds(275,370,120,20);
...
//Add Books Button
		JButton addBooks_Button = new JButton("Add Book");
		addBooks_Button.setBounds(740,150,212,30);
		addBooks_Button.setFont(new Font ("Arial", Font.BOLD,15));
		addBooks_Button.setCursor(new Cursor(Cursor.HAND_CURSOR));
		addBooks_Button.setBackground(Dark_CYAN);
		addBooks_Button.setForeground(Color.BLACK);
		panel.add(addBooks_Button);
		
		//Set Add Books Hover
		addBooks_Button.addMouseListener(new java.awt.event.MouseAdapter() {
			public void mouseEntered(java.awt.event.MouseEvent evt) {
				addBooks_Button.setBackground(LIGHT_RED);
				addBooks_Button.setForeground(Color.WHITE);
			}
