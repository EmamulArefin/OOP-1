...
public class Change_Name{
	...
	String user, newName, user_username, user_password, user_balance, user_email, user_phone, user_gender, user_name;
	
	
	
	
	public Change_Name(int fileNo){this.fileNo=fileNo;}
	...
	public Change_Name()
	{
		...
		frame.setTitle("New Password Panel");
...
//Back Button
		...
		Back_Button.setBounds(880,537,90,20);
		Back_Button.setFont(new Font("Arial", Font.BOLD, 13));
		Back_Button.setBackground(Dark_Blue);
		...
		Back_Button.addMouseListener(new java.awt.event.MouseAdapter() {
			public void mouseEntered(java.awt.event.MouseEvent evt) {
				Back_Button.setBackground(Dark_CYAN);
				Back_Button.setForeground(Color.WHITE);
			}
...
//Set Background Image
		...
		changeName_Button.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent a){
				// newName=firstname_Field.getText()+" "+lastname_Field.getText();
...
//Got the all information about user|||||Now time to display them
				...
				JOptionPane.showMessageDialog(null, "Name Successfully change to "+ newName,"Successfully Name Changed",-1,new ImageIcon("C:\\Users\\Asus\\Desktop\\Final Project\\SOURCES\\Images\\Successful_Icon.png"));
