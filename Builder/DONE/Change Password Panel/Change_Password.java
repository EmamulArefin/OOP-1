...
//Colors
	...
	public Change_Password(int fileNo){this.fileNo=fileNo;}//Need to call from account signup panel > back to login button listener
...
//Enter New Password
		JLabel new_Password_Label = new JLabel("Enter Current Password");
...
//Got the all information about user|||||Now time to modify them
				...
				if(currentPass.equals(user_password)){
					if( (newPass.length()<6) || (newPass.length()>10) )
					{
						...
						JOptionPane.showMessageDialog(null, "Successfully Password Changed","Password Changed",-1,new ImageIcon("C:\\Users\\Asus\\Desktop\\Final Project\\SOURCES\\Images\\Successful_Icon.png"));
					}
